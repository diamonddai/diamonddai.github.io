...
# 示例数据和标签
data = [
    {"user_id": 1, "user_latent_feature": [0.1, 0.2, 0.3], "user_interest": "arts and fashion"},
    {"user_id": 2, "user_latent_feature": [0.2, 0.1, 0.4], "user_interest": "arts and fashion"},
    # 添加更多用户数据
]
...
# 计算类内和类间距离
intra_distances, inter_distances = calculate_cluster_distances(data, labels)
