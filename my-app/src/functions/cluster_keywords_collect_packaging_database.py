...
def get_user_division_from_db(db_config):
    ...
    cursor.execute("SELECT user_id, user_latent_feature, user_interest, user_interest_index FROM user_division")
...
def get_user_texts_keywords(file_path):
